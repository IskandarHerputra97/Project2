...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button1.layer.borderColor = UIColor(red: 1.0, green: 0.0, blue: 0.0, alpha: 1.0).cgColor
        button2.layer.borderColor = UIColor(red: 0.0, green: 1.0, blue: 0.0, alpha: 1.0).cgColor
    ...
    func askQuestion(action: UIAlertAction!) {
        ...
        if questionNumber <= 10 {
            title = "\(questionNumber). \(countries[correctAnswer].uppercased()) - Score : \(score)"
        } else {
